# LHS Analtics Data Delivery

This folder defines all source code for the 'LHS Analtics Data Delivery' pipeline:
...
* Take a look at the sample under "sample_users_lhs_analtics_data_delivery.py" to get familiar with the syntax.
